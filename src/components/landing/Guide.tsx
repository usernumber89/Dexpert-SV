...
const steps = [
  { 
    ...
    description: "Creá tu cuenta como estudiante o dueño de una pequeña empresa. Solo toma un minuto.",
    icon: UserPlus,
    color: "#38A3F1",
  },
  { 
    title: "Explorá y aplicá a proyectos", 
    description: "Descubrí proyectos reales de empresas que necesitan tus habilidades. Aplica o seleccioná con quién trabajar.",
    icon: Search,
    color: "#18508f",
  },
  { 
    title: "Trabajá con soporte de IA", 
    description: "Recibí retroalimentación y sugerencias continuas de nuestro Product Owner AI a lo largo del proyecto.",
    icon: Network,
    color: "#38A3F1",
  },
  { 
    title: "Obtené resultados y reconocimiento", 
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-[#5B8DB8] max-w-2xl text-sm mx-auto">
            Desde el registro hasta la certificación — tu viaje hacia el crecimiento profesional comienza acá.
          </p>
        </motion.div>
            ...
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="hidden lg:grid lg:grid-cols-2 lg:gap-16 items-center mb-16 relative">
                    {/* Left Column */}
                    <div className={`${isEven ? '' : 'invisible'}`}>
                      {isEven ? (
                        ...
                        <div className="max-w-md ml-auto opacity-0 pointer-events-none select-none">
                          <div className="flex items-center gap-3 mb-3 justify-end">
                    ...
                    <div className={`${!isEven ? '' : 'invisible'}`}>
                      {!isEven ? (
                        ...
                        <div className="max-w-md mr-auto opacity-0 pointer-events-none select-none">
                          <div className="flex items-center gap-3 mb-3">
                            <Icon className="w-5 h-5" />
                            <h3 className="text-xl font-bold">{step.title}</h3>
                          </div>
